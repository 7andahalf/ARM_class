...
; Testing
; running this program prints 0001111100000110011011100000
; This modifies the weights and biases so that the gates shall produce correct output
; NOT gate nagetes first bit
; It is not possible to implement a XOR or XNOR using a single perceptron
...
w_or	VLDR.F32 S13, = 0.2
		VLDR.F32 S14, = 0.2
		VLDR.F32 S15, = 0.2
		VLDR.F32 S16, = -0.1
		BX	lr
		
w_and	VLDR.F32 S13, = 0.2
		VLDR.F32 S14, = 0.2
		VLDR.F32 S15, = 0.2
		VLDR.F32 S16, = -0.5
		BX	lr
		
w_not	VLDR.F32 S13, = 0.2
		VLDR.F32 S14, = 0
		VLDR.F32 S15, = 0
		VLDR.F32 S16, = -0.5
		BX	lr
...
w_nand	VLDR.F32 S13, = -0.2
		VLDR.F32 S14, = -0.2
		VLDR.F32 S15, = -0.2
		VLDR.F32 S16, = 0.5
		BX	lr
		
w_nor	VLDR.F32 S13, = -0.2
		VLDR.F32 S14, = -0.2
		VLDR.F32 S15, = -0.2
		VLDR.F32 S16, = 0.1
		BX	lr
